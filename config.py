...
def get_config():
    ...
    # AutoPipe apecific parameters
    parser.add_argument("--migration_cost_factor", type=float, default=0.1, help="cost factor for layer migration")
    parser.add_argument("--reward_throughput_factor", type=float, default=1.0, help="reward factor for throughput")
